...
let projects = [
  {
    image: "textures/furnicom.jpg",
    // url: "https://www.spaze.social/",
  },
  {
    image: "textures/mam-apa.png",
    // url: "https://myteachers.com.au/",
  },
  {
    image: "textures/web-travel.png",
    url: "https://mbahdukun1.github.io/Travelaku-app/",
  },
  {
    image: "textures/db-movie.png",
  ...
  function (room) {
    ...
    room.scene.children.forEach((child) => {
      ...
      if (child.name === "Book") {
        ...
        const bookTexture = new THREE.TextureLoader().load("textures/book-inner2.jpg");
...
function loadIntroText() {
  ...
  loader.load("fonts/unione.json", function (font) {
    ...
    const titleGeo = new TextGeometry("DICKY MAULANA", {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load("fonts/helvatica.json", function (font) {
    const textMaterials = [new THREE.MeshPhongMaterial({ color: 0x171f27, flatShading: true }), new THREE.MeshPhongMaterial({ color: 0xffffff })];
    const subTitleGeo = new TextGeometry("Full Stack Developer / Mobile Developer", {
      font: font,
      size: 0.018,
      height: 0,
    });
